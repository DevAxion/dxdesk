...
DXDesk.Client.NativeMethods.EnableDpiAwareness();
...
// ---- Agent rejimi ----
// Xidmət (DXDesk.Service) bunu aktiv sessiyada SYSTEM kimi buraxır:
//   DXDesk.Client.exe --agent <relayUrl> <hostname> <port>
...
Log($"DXDesk Client başladı. Hostname: {hostname}, Relay: {relayUrl}");
await ConnectLoopAsync();
