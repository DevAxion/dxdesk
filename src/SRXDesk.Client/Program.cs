...
using SRXDesk.Client;

// Miqyaslanmış ekranlarda tam çözünürlük üçün ƏN BAŞDA DPI-aware et.
SRXDesk.Client.NativeMethods.EnableDpiAwareness();
...
// ---- Agent rejimi ----
// Xidmət (SRXDesk.Service) bunu aktiv sessiyada SYSTEM kimi buraxır:
//   SRXDesk.Client.exe --agent <relayUrl> <hostname> <port>
...
Log($"SRXDesk Client başladı. Hostname: {hostname}, Relay: {relayUrl}");
await ConnectLoopAsync();
